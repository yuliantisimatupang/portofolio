...
export default function SectionService() {
  ...
  return (
    <section className="font-sans flex flex-col pt-14 pb-10 text-black-primary bg-primary-1 min-h-screen h-fit overflow-hidden">
      <div className="w-container">
        ...
        </div>
        {
          dataExperience.map(data => {
            return (
              <div className="p-6 mb-5 w-full lg:max-w-xs bg-primary-2 rounded-xl border-2 border-line-dark">
